...
(function () {
    ...
    const GRID_STYLE = [
        '#ss-panel .ss-grid {',
        '  display:grid; grid-template-columns: repeat(var(--grid-cols, 8), 44px);',
        ...
        '}',
        '#ss-panel .tsic-slot:hover { background: rgba(241,229,207,0.88); }',
        ...
        '#ss-panel .tsic-slot.is-drop-target { outline:2px solid var(--cat-green, #3f7d4f); outline-offset:-2px; }',
        '#ss-panel .tsic-slot.is-filtered { opacity:0.22; }',
