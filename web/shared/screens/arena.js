...
(function register() {
  ...
  const STYLE = `
    ...
    [data-screen="Arena"] .ar-combo-list li { padding: 3px 8px; font-size: 12px; color: var(--ink-night, #14110c); cursor: pointer; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
